<div id="pages-controller-cms-content" class="cms-content center cms-tabset $BaseCSSClasses" data-layout-type="border" data-pjax-fragment="Content">
		...
		<div class="cms-content-header-tabs">
			<ul>
				<li class="content-treeview<% if ViewState == tree %> ui-tabs-active<% end_if %>">
					<a href="#categoryadmin-content-treeview" class="cms-panel-link" data-href="$LinkTreeView"><% _t('CMSPagesController.TreeView', 'Tree View') %></a>
				</li>
                                <!--
				<li class="content-listview<% if ViewState == list %> ui-tabs-active<% end_if %>">
					<a href="#categoryadmin-content-listview" class="cms-panel-link" data-href="$LinkListView"><% _t('CMSPagesController.ListView', 'List View') %></a>
				</li>
	...
	<div class="cms-content-fields center ui-widget-content cms-panel-padded">
		...
		<div class="cms-content-view cms-panel-deferred" id="categoryadmin-content-treeview" data-url="$LinkTreeView">
			<%-- Lazy-loaded via ajax --%>
		</div>
                <!--
		<div class="cms-content-view cms-panel-deferred" id="categoryadmin-content-listview" data-url="$LinkListView" data-deferred-no-cache="true">
			<%-- Lazy-loaded via ajax --%>
		</div>
