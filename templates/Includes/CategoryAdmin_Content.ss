<div id="pages-controller-cms-content" class="cms-content center cms-tabset $BaseCSSClasses" data-layout-type="border" data-pjax-fragment="Content" data-ignore-tab-state="true">
	...
	<div class="cms-content-header north">
		...
		<div class="cms-content-header-tabs">
			<ul>
				<li class="content-treeview<% if class == 'CategoryAdminEditController' %> ui-tabs-active<% end_if %>">
					<a href="$LinkCategoryEdit" class="cms-panel-link" title="Form_EditForm" data-href="$LinkCategoryEdit">
